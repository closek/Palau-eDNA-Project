...
# does not work on other's computers - inflexible file path - above works within the Rproj and across Mac/PC
...
```{r}
po <- plot_ordination(physeq2, physeq2.ord, type = "samples", color = "Zone", shape = "Near_or_Offshore", title = "Nearshore & Offshore Samples")
po
