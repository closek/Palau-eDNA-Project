...
# to see a snippet of the data run this in the console 
...
# save clean data
write_csv(esv_clean_data, file = file.path(dir_data_proc, "esv_clean_data_rv.csv"))
...
esv_clean_data_df <- read_csv(file.path(dir_data_proc, "esv_clean_data_rv.csv"))
...
# save files
write_csv(offshore_esv, file = file.path(dir_data_proc, "offshore_esv.csv"))
write_csv(nearshore_esv, file = file.path(dir_data_proc, "nearshore_esv.csv"))
```
...
write_csv(offshore_esv_sp, file = file.path(dir_data_proc, "offshore_esv_sp.csv"))
write_csv(nearshore_esv_sp, file = file.path(dir_data_proc, "nearshore_esv_sp.csv"))

```

### Unique nearshore species

#### Thea stopped here with cleanup
