...
3) Create Nearshore & Offshore dataframes

```{r create-nearshore-offshore-data}
# if esv file for this analysis date already exists: do nothing
# if esv file does not exist: run code and save

##### offshore
if (!dir.exists(file.path(dir_data_proc, 
                          paste0("offshore_esv_", analysis_date, ".csv")))) {
  ...
  write_csv(offshore_esv, 
            file = file.path(dir_data_proc,
                             paste0("offshore_esv_", analysis_date, ".csv")))
}

###### nearshore
if (!dir.exists(file.path(dir_data_proc, 
                          paste0("nearshore_esv_", analysis_date, ".csv")))) {
  # create offshore_esv dataframe
...
3) Create Nearshore & Offshore species lists

```{r create-near-offshore-species-list}
# similar to code chunk above - if output file already exists, code will not run

#### offshore species
if (!dir.exists(file.path(dir_data_proc, paste0("offshore_esv_sp_", analysis_date, ".csv")))) {
  ...
  write_csv(offshore_esv_sp, 
            file = file.path(dir_data_proc, 
                             paste0("offshore_esv_sp_", analysis_date,".csv")))
}

#### nearshore species
if (!dir.exists(file.path(dir_data_proc, paste0("nearshore_esv_sp_", analysis_date, ".csv")))) {
  ...
  write_csv(nearshore_esv_sp, 
            file = file.path(dir_data_proc, 
                             paste0("nearshore_esv_sp_", analysis_date, ".csv")))
}
```
